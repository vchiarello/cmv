...
class SemaforoEvento{
	...
	function putSemaforo($name){
		...
		$select = "update cmv.anag_schedulazioni set semaforo = :valore where descrizione_schedulazione='Evento'";
...
$server = new SoapServer("SemaforoEvento.wsdl");
$server->setClass("SemaforoEvento");
