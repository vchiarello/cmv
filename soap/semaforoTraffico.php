...
class SemaforoTraffico{
	...
	function putSemaforo($name){
		...
		$select = "update cmv.anag_schedulazioni set semaforo = :valore where descrizione_schedulazione='Traffico'";
		...
		return array("semaforo" =>array("valore"=>$valore,"messaggioEsito"=>"Aggiornamento eseguito"));
	}
...
$server = new SoapServer("SemaforoTraffico.wsdl");
$server->setClass("SemaforoTraffico");
